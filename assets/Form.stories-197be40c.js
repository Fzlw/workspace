...
https://element-plus.org/zh-CN/component/form.html`}}}},b={args:{model:{},columns:[{prop:"name",formItemProps:{prop:"name",label:"name",required:!0}},{prop:"age",rType:"number",min:1,formItemProps:{prop:"age",label:"age"}},{rType:"date",label:"date",prop:"date",formItemProps:{prop:"date",label:"date"}}]},render(r){return{components:{Form:l},setup(){const e=be();return{args:r,formRef:e,click:()=>{var a;(a=e.value)==null||a.elForm.validate(o=>{console.log("valid",o)})}}},template:`
      ...
      `}}},f={render(){return{components:{Form:l,ElDialog:Te,ElButton:d},setup(){const{formState:r,setModel:e}=u({columns:[{rType:"remote",prop:"remote",valueKey:"id",labelKey:"labelVal",method([m,t,T]){return new Promise(ge=>{setTimeout(()=>{ge({list:new Array(20).fill(1).map((Se,S)=>({labelVal:`l-${m.currentPage}-${S}`,id:`i-${m.currentPage}-${S}-${t||0}`})),total:50})},1e3)})},clearable:!0,filterable:!0,noCache:!0}]}),n=be(!1);return{formState:r,toggle:()=>n.value=!n.value,visible:n,open:()=>e({remote:"i-1-2-0",labelVal:"l-1-2"})}},template:`
      ...
      `}}};var _,h,w;b.parameters={...b.parameters,docs:{...(_=b.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    model: {},
    columns: [{
      prop: 'name',
...
}`,...(w=(h=b.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};var B,k,P,C,D;s.parameters={...s.parameters,docs:{...(B=s.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render() {
    return {
      components: {
        Form,
...
需要使用组件实例可以使用 const { form } = useForm()`,...(D=(C=s.parameters)==null?void 0:C.docs)==null?void 0:D.description}}};var A,K,q;g.parameters={...g.parameters,docs:{...(A=g.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render() {
    return {
      components: {
        Form
...
}`,...(q=(K=g.parameters)==null?void 0:K.docs)==null?void 0:q.source}}};var M,V,x,L,R;p.parameters={...p.parameters,docs:{...(M=p.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render() {
    return {
      components: {
        Form
...
}`,...(x=(V=p.parameters)==null?void 0:V.docs)==null?void 0:x.source},description:{story:"配合 @vitejs/plugin-vue-jsx 使用",...(R=(L=p.parameters)==null?void 0:L.docs)==null?void 0:R.description}}};var j,N,I,J,O;i.parameters={...i.parameters,docs:{...(j=i.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render() {
    return {
      components: {
        Form
...
}`,...(I=(N=i.parameters)==null?void 0:N.docs)==null?void 0:I.source},description:{story:"内部使用 OneRemoteSelect 组件",...(O=(J=i.parameters)==null?void 0:J.docs)==null?void 0:O.description}}};var G,X,z;F.parameters={...F.parameters,docs:{...(G=F.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render() {
    return {
      components: {
        Form
...
//# sourceMappingURL=Form.stories-197be40c.js.map
