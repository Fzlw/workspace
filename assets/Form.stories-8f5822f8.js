...
https://element-plus.org/zh-CN/component/form.html`}}}},c={args:{model:{},columns:[{prop:"name",formItemProps:{prop:"name",label:"name",required:!0}},{prop:"age",rType:"number",min:1,formItemProps:{prop:"age",label:"age"}},{rType:"date",label:"date",prop:"date",formItemProps:{prop:"date",label:"date"}}]},render(r){return{components:{Form:l},setup(){const e=oe();return{args:r,formRef:e,click:()=>{var a;(a=e.value)==null||a.validate(o=>{console.log("valid",o)})}}},template:`
      ...
      `}}};var $,S,T;c.parameters={...c.parameters,docs:{...($=c.parameters)==null?void 0:$.docs,source:{originalSource:`{
  args: {
    model: {},
    columns: [{
      prop: 'name',
...
}`,...(T=(S=c.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};var B,h,k,w,_;m.parameters={...m.parameters,docs:{...(B=m.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render() {
    return {
      components: {
        Form,
...
}`,...(k=(h=m.parameters)==null?void 0:h.docs)==null?void 0:k.source},description:{story:`OneForm 组件实例 ref此时由useForm 代理
需要使用组件实例可以使用 const { form } = useForm()`,...(_=(w=m.parameters)==null?void 0:w.docs)==null?void 0:_.description}}};var P,C,D;d.parameters={...d.parameters,docs:{...(P=d.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render() {
    return {
      components: {
        Form
...
}`,...(D=(C=d.parameters)==null?void 0:C.docs)==null?void 0:D.source}}};var A,q,M,K,x;s.parameters={...s.parameters,docs:{...(A=s.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render() {
    return {
      components: {
        Form
...
}`,...(M=(q=s.parameters)==null?void 0:q.docs)==null?void 0:M.source},description:{story:"配合 @vitejs/plugin-vue-jsx 使用",...(x=(K=s.parameters)==null?void 0:K.docs)==null?void 0:x.description}}};var L,R,V,I,j;p.parameters={...p.parameters,docs:{...(L=p.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render() {
    return {
      components: {
        Form
...
//# sourceMappingURL=Form.stories-8f5822f8.js.map
